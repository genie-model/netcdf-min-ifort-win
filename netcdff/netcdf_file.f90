...
function nf90_inq_libvers()
  !DEC$ ATTRIBUTES DLLEXPORT :: nf90_inq_libvers
...
function nf90_strerror(ncerr)
  !DEC$ ATTRIBUTES DLLEXPORT :: nf90_strerror
...
function nf90_inq_base_pe(ncid, pe)
  !DEC$ ATTRIBUTES DLLEXPORT :: nf90_inq_base_pe
...
function nf90_set_base_pe(ncid, pe)
  !DEC$ ATTRIBUTES DLLEXPORT :: nf90_set_base_pe
...
function nf90_create_mp(path, cmode, initalsz, basepe, chunksizehint, ncid)
  !DEC$ ATTRIBUTES DLLEXPORT :: nf90_create_mp
...
function nf90_open_mp(path, mode, basepe, chunksizeint, ncid)
  !DEC$ ATTRIBUTES DLLEXPORT :: nf90_open_mp
  character (len = *), intent( in) :: path
...
function nf90_set_fill(ncid, fillmode, old_mode)
  !DEC$ ATTRIBUTES DLLEXPORT :: nf90_set_fill
...
function nf90_redef(ncid)
  !DEC$ ATTRIBUTES DLLEXPORT :: nf90_redef
  integer, intent( in) :: ncid
  integer              :: nf90_redef
...
function nf90_enddef(ncid, h_minfree, v_align, v_minfree, r_align)
  !DEC$ ATTRIBUTES DLLEXPORT :: nf90_enddef
  integer,           intent( in) :: ncid
...
function nf90_sync(ncid)
  !DEC$ ATTRIBUTES DLLEXPORT :: nf90_sync
  integer, intent( in) :: ncid
  integer              :: nf90_sync
...
function nf90_abort(ncid)
  !DEC$ ATTRIBUTES DLLEXPORT :: nf90_abort
  integer, intent( in) :: ncid
  integer              :: nf90_abort
...
function nf90_close(ncid)
  !DEC$ ATTRIBUTES DLLEXPORT :: nf90_close
  integer, intent( in) :: ncid
  integer              :: nf90_close
...
function nf90_delete(name)
  !DEC$ ATTRIBUTES DLLEXPORT :: nf90_delete
...
function nf90_inquire(ncid, nDimensions, nVariables, nAttributes, unlimitedDimId, formatNum)
  !DEC$ ATTRIBUTES DLLEXPORT :: nf90_inquire
  integer,           intent( in) :: ncid
...
function nf90_inq_path(ncid, pathlen, path)
  !DEC$ ATTRIBUTES DLLEXPORT :: nf90_inq_path
  integer,            intent(in)    :: ncid
